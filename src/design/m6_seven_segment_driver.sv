module m6_seven_segment_driver (
    ...
    always_comb begin
        case (current_hex_digit)
            ...
            4'hA: seg = 7'b1110111; 
            4'hB: seg = 7'b1111100; 
            4'hC: seg = 7'b0000000;  //Aqui se cambió el display para en vez de mostrar una "C" muestre un guion "-" ya que nuestro C funciona como un full clear
            4'hD: seg = 7'b1011110; 
            4'hE: seg = 7'b1111001; 
            4'hF: seg = 7'b1110001; 
            default: seg = 7'b0000000; // Todos los segmentos apagados
        endcase
    end
